...
public sealed class ShipClassTypeHandlerTest
{
    private static readonly ShipClassTypeHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Ship_Class", XmlValueType.ShipClassType);
    ...
    [Fact]
    public void Non_ship_class_type_tag_returns_no_diagnostics()
    {

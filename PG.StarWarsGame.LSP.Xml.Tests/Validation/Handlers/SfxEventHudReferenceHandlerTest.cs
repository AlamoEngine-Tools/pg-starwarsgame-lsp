...
public sealed class SfxEventHudReferenceHandlerTest
{
    private static readonly SfxEventHudReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("HUD_SFX", XmlValueType.SfxEventHudReference);

    [Theory]
    [InlineData("SFX_HUD_Click")]
    [InlineData("SFX_HUD_Alert")]

...
public sealed class LocalisationToTextureMapHandlerTest
{
    private static readonly LocalisationToTextureMapHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Tooltip_Texture", XmlValueType.LocalisationToTextureMap);

    [Theory]
    [InlineData("TEXT_KEY_ATTACK, Icon_Attack.alo")]
    [InlineData("TEXT_KEY_MOVE,Icon_Move.alo")]
    ...
    [Theory]
    [InlineData("")]
    [InlineData("TEXT_KEY_ATTACK")]
    [InlineData(",Icon_Attack.alo")]
    [InlineData("TEXT_KEY_ATTACK,")]

...
public sealed class PositionLabelHandlerTest
{
    private static readonly PositionLabelHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Hardpoint_Name", XmlValueType.PositionLabel);

    [Theory]
    [InlineData("HP_ROOT")]
    [InlineData("TURRET_01")]
    ...
    [Fact]
    public void Non_position_label_tag_returns_no_diagnostics()
    {

...
public sealed class SFXEventReferenceHandlerTest
{
    private static readonly SFXEventReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Death_SFX", XmlValueType.SFXEventReference);

    [Theory]
    [InlineData("Unit_Death_Explosion")]
    [InlineData("SFX_Laser_Hit")]

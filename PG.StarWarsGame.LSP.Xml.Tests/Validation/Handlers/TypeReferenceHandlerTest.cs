...
public sealed class TypeReferenceHandlerTest
{
    private static readonly TypeReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Particle_Effect", XmlValueType.TypeReference);

    [Theory]
    [InlineData("EXPLOSION_SMALL")]
    [InlineData("Particle_Effect_01")]

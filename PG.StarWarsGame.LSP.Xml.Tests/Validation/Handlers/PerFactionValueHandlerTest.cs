...
public sealed class PerFactionValueHandlerTest
{
    private static readonly PerFactionValueHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Starting_Credits", XmlValueType.PerFactionValue);

    [Theory]
    [InlineData("REBEL, 10000")]
    [InlineData("EMPIRE,5000")]
    [InlineData("NEUTRAL, 1.5")]

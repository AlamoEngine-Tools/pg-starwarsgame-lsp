...
public sealed class DeathCloneSpecHandlerTest
{
    private static readonly DeathCloneSpecHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Death_Clone", XmlValueType.DeathCloneSpec);

    [Theory]
    [InlineData("DESTROY, Clone_Type_A")]
    [InlineData("KILL,CloneB")]

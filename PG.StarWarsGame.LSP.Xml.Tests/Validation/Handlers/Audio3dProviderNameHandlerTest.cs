...
public sealed class Audio3dProviderNameHandlerTest
{
    private static readonly Audio3dProviderNameHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Audio_3D_Provider_Name", XmlValueType.Audio3dProviderName);
    ...
    [Fact]
    public void Non_audio_3d_provider_tag_returns_no_diagnostics()
    {

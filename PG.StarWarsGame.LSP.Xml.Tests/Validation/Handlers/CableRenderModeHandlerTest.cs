...
public sealed class CableRenderModeHandlerTest
{
    private static readonly CableRenderModeHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Cable_Render_Mode", XmlValueType.CableRenderMode);
    ...
    [Fact]
    public void Non_cable_render_mode_tag_returns_no_diagnostics()
    {

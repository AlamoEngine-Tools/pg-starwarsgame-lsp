...
public sealed class SpeechEventReferenceHandlerTest
{
    private static readonly SpeechEventReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Combat_Chatter", XmlValueType.SpeechEventReference);

    [Theory]
    [InlineData("Speech_Attack")]
    [InlineData("Speech_Death")]

...
public sealed class MusicEventReferenceHandlerTest
{
    private static readonly MusicEventReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Combat_Music", XmlValueType.MusicEventReference);

    [Theory]
    [InlineData("Music_Battle_01")]
    [InlineData("Music_Victory")]

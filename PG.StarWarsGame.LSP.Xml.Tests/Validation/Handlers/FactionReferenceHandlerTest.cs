...
public sealed class FactionReferenceHandlerTest
{
    private static readonly FactionReferenceHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Faction", XmlValueType.FactionReference);

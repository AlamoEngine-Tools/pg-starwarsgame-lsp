...
public sealed class CommandBarPropertyHandlerTest
{
    private static readonly CommandBarPropertyHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("GUI_Property", XmlValueType.CommandBarProperty);

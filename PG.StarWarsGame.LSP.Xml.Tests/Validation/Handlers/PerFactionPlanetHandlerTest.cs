...
public sealed class PerFactionPlanetHandlerTest
{
    private static readonly PerFactionPlanetHandler Sut = new();

    private static readonly XmlTagDefinition Tag =
        XmlHandlerTestFixtures.MakeTag("Home_Planet", XmlValueType.PerFactionPlanet);

    [Theory]
    [InlineData("REBEL, Yavin4")]
    [InlineData("EMPIRE,Coruscant")]

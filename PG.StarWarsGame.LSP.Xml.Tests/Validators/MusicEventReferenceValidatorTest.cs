...
public sealed class MusicEventReferenceValidatorTest
{
    private static readonly MusicEventReferenceValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Music_Event", XmlValueType.MusicEventReference);

    [Theory]
    [InlineData("MUS_IMPERIAL_MARCH")]
    [InlineData("rebel_theme_01")]
    [InlineData("Battle Theme Intense")]
    public void Valid_music_event_references_pass(string value)

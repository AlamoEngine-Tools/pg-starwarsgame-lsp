...
public sealed class NameReferenceValidatorTest
{
    private static readonly NameReferenceValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Unit_Name", XmlValueType.NameReference);

    [Theory]
    [InlineData("UNIT_EMPIRE_STORMTROOPER")]
    [InlineData("my_unit")]
    [InlineData("Some Unit Name")]
    public void Valid_name_references_pass(string value)
    {

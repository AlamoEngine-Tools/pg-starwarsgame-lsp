...
{
    private static readonly TypeReferenceListValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Damage_Types", XmlValueType.TypeReferenceList);

    [Theory]
    [InlineData("DAMAGE_LASER")]

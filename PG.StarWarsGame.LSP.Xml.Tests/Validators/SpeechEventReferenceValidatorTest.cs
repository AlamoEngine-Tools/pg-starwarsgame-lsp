...
public sealed class SpeechEventReferenceValidatorTest
{
    private static readonly SpeechEventReferenceValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Speech_Event", XmlValueType.SpeechEventReference);

    [Theory]
    [InlineData("SPEECH_VADER_ATTACK")]
    [InlineData("palpatine_speech_01")]
    [InlineData("Han Solo Greeting")]
    public void Valid_speech_event_references_pass(string value)
    {

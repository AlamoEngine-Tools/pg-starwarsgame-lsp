...
{
    private static readonly ProjectileCategoryValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Projectile_Category", XmlValueType.ProjectileCategory);

...
public sealed class TypeReferenceValidatorTest
{
    private static readonly TypeReferenceValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Damage_Type", XmlValueType.TypeReference);

    [Theory]
    [InlineData("DAMAGE_TYPE_EXPLOSIVE")]
    [InlineData("Infantry")]
    [InlineData("Super Star Destroyer")]
    public void Valid_type_references_pass(string value)
    {

...
public sealed class Audio3dProviderNameValidatorTest
{
    private static readonly Audio3dProviderNameValidator Sut = new();
    private static readonly XmlTagDefinition Tag = TagOf.Make("Audio_3D_Provider", XmlValueType.Audio3dProviderName);

    [Theory]
    [InlineData("Miles Fast 2D Positional")]
    [InlineData("DirectSound3D")]
    [InlineData("EAX3")]
    public void Valid_provider_names_pass(string value)

...
public sealed class XmlTagNameCompletionStrategyRegistrationTest
{
    private static IReadOnlyCollection<Type> AllConcreteStrategyTypes()
    {
        return typeof(XmlLanguageServiceExtensions).Assembly
            ...
            .Where(t => t is { IsClass: true, IsAbstract: false }
                        && typeof(IXmlTagNameCompletionStrategy).IsAssignableFrom(t))
            .ToList();
    }
    ...
    private static IReadOnlyCollection<Type> RegisteredStrategyTypes()
    {
        ...
        return services
            .Where(d => d.ServiceType == typeof(IXmlTagNameCompletionStrategy))

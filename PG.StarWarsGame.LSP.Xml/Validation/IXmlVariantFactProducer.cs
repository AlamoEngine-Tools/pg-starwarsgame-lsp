...
///     overrides of ignored tags, and redundant overrides. Needs the document text (for tag positions)
///     and the index (for chain resolution via <see cref="EffectiveObjectResolver" />).
/// </summary>
